...
add_file -verilog "../rtl/ddr2_sdram.v"
add_file -verilog "../rtl/ddr2_tb_test_addr_gen.v"
add_file -verilog "../rtl/ddr2_tb_test_cmp.v"
add_file -verilog "../rtl/ddr2_tb_test_data_gen.v"
add_file -verilog "../rtl/ddr2_tb_test_gen.v"
add_file -verilog "../rtl/ddr2_tb_top.v"
...
set_option -top_module "ddr2_sdram"

#map options
set_option -frequency 266.66
...
project -result_file "../synth/rev_1/ddr2_sdram.edf"
