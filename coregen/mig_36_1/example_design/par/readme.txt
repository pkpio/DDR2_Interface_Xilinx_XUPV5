...
* "mig_36_1.ucf" file is the constraint file for the design. This is used by
...
* "mem_interface_top.ut" file has the options for the Configuration file
  generation i.e. the "mig_36_1.bit" file to run in batch mode.
...
* "icon4_cg.xco", "vio_async_in96_cg.xco", "vio_async_in100_cg.xco",
  ...
  mig_36_1 rtl file. In order to generate the EDIF/NGC files, you must
...
Note : When you generate the design using DEBUG_EN option, the above mentioned
       ...
       create_ise.bat files. The mig_36_1 rtl file will have the design
...
* Synth folder has the constraint file for Synplify Pro designs
  i.e. the "mem_interface_top_synp.sdc" file, "mig_36_1.prj" file which
  has the design files to be added to the project, "script_synp.tcl" file
  that sets the synthesis options and "mig_36_1.lso" file which is a custom
