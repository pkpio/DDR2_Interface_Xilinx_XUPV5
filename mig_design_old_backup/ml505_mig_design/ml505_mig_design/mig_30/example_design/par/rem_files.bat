...
IF EXIST mig_30_vhdl.prj del /F /Q mig_30_vhdl.prj
IF EXIST mem_interface_top.syr del /F /Q mem_interface_top.syr
IF EXIST mig_30.ngc del /F /Q mig_30.ngc
IF EXIST mig_30.ngo del /F /Q mig_30.ngo
IF EXIST netlist.lst del /F /Q netlist.lst
IF EXIST mig_30.ngr del /F /Q mig_30.ngr
IF EXIST mig_30_xst.xrpt del /F /Q mig_30_xst.xrpt
IF EXIST mig_30.bld del /F /Q mig_30.bld
IF EXIST mig_30.ngd del /F /Q mig_30.ngd
IF EXIST mig_30_ngdbuild.xrpt del /F /Q  mig_30_ngdbuild.xrpt
IF EXIST mig_30_map.map del /F /Q  mig_30_map.map
IF EXIST mig_30_map.mrp del /F /Q  mig_30_map.mrp
IF EXIST mig_30_map.ngm del /F /Q  mig_30_map.ngm
IF EXIST mig_30.pcf del /F /Q  mig_30.pcf
IF EXIST mig_30_map.ncd del /F /Q  mig_30_map.ncd
IF EXIST mig_30_map.xrpt del /F /Q  mig_30_map.xrpt
IF EXIST mig_30_summary.xml del /F /Q  mig_30_summary.xml
IF EXIST mig_30_usage.xml del /F /Q  mig_30_usage.xml
IF EXIST mig_30.ncd del /F /Q  mig_30.ncd
IF EXIST mig_30.par del /F /Q  mig_30.par
IF EXIST mig_30.xpi del /F /Q  mig_30.xpi
IF EXIST smartpreview.twr del /F /Q  smartpreview.twr
IF EXIST mig_30.ptwx del /F /Q  mig_30.ptwx
IF EXIST mig_30.pad del /F /Q  mig_30.pad
IF EXIST mig_30.unroutes del /F /Q  mig_30.unroutes
IF EXIST mig_30_pad.csv del /F /Q  mig_30_pad.csv
IF EXIST mig_30_pad.txt del /F /Q  mig_30_pad.txt
IF EXIST mig_30_par.xrpt del /F /Q  mig_30_par.xrpt
IF EXIST mig_30.twx del /F /Q  mig_30.twx
IF EXIST mig_30.bgn del /F /Q  mig_30.bgn
IF EXIST mig_30.twr del /F /Q  mig_30.twr
IF EXIST mig_30.drc del /F /Q  mig_30.drc
IF EXIST mig_30.bit del mig_30.bit
...
IF EXIST xst rmdir /S /Q xst 
IF EXIST mig_30.lso del /F /Q mig_30.lso
IF EXIST mig_30.prj del /F /Q mig_30.prj
IF EXIST mig_30.xst del /F /Q mig_30.xst
IF EXIST mig_30.stx del /F /Q mig_30.stx
IF EXIST mig_30.syr del /F /Q mig_30.syr
IF EXIST mig_30_prev_built.ngd del /F /Q mig_30_prev_built.ngd
IF EXIST test.ntrc_log del /F /Q test.ntrc_log
IF EXIST mig_30_guide.ncd del /F /Q mig_30_guide.ncd
IF EXIST mig_30.ut del /F /Q mig_30.ut
IF EXIST mig_30.cmd_log del /F /Q mig_30.cmd_log
IF EXIST device_usage_statistics.html del /F /Q device_usage_statistics.html
IF EXIST mig_30_summary.html del /F /Q mig_30_summary.html
